...
int main(int argc, char **argv){
    ...
    2.0*0.0454063328691*adag(1)*adag(2)*a(3)*a(0) + 0.168335986252*adag(0)*adag(2)*a(2)*a(0) + 
    0.165606823582*adag(0)*adag(3)*a(3)*a(0) - 0.0454063328691*adag(3)*adag(0)*a(2)*a(1) + 
    -0.0454063328691*adag(1)*adag(3)*a(0)*a(2) - 2.0*0.0454063328691*adag(3)*adag(1)*a(2)*a(0) +
     0.165606823582*adag(1)*adag(2)*a(2)*a(1) - 0.165606823582*adag(0)*adag(3)*a(0)*a(3)+ 
    -0.479677813134*adag(3)*a(3) - 0.0454063328691*adag(1)*adag(2)*a(0)*a(3) - 
    ...
    -2.0*0.0454063328691*adag(2)*adag(1)*a(3)*a(0) - 0.120200490713*adag(2)*adag(3)*a(2)*a(3) + 
    ...
    2.0*0.0454063328691*adag(1)*adag(3)*a(2)*a(0) - 1.2488468038*adag(0)*a(0) +
     0.0454063328691*adag(3)*adag(1)*a(0)*a(2) - 0.168335986252*adag(2)*adag(0)*a(2)*a(0) + 
     0.165606823582*adag(3)*adag(0)*a(0)*a(3) - 0.0454063328691*adag(2)*adag(0)*a(3)*a(1) + 
     0.0454063328691*adag(2)*adag(0)*a(1)*a(3) - 1.2488468038*adag(2)*a(2) + 
     0.0454063328691*adag(2)*adag(1)*a(0)*a(3)+ 0.174072892497*adag(3)*adag(1)*a(1)*a(3) - 
     0.479677813134*adag(1)*a(1) - 0.174072892497*adag(3)*adag(1)*a(3)*a(1) + 
    0.0454063328691*adag(3)*adag(0)*a(1)*a(2) - 0.165606823582*adag(3)*adag(0)*a(3)*a(0) + 
    0.0454063328691*adag(0)*adag(3)*a(2)*a(1) - 0.165606823582*adag(2)*adag(1)*a(2)*a(1)+ 
    -0.120200490713*adag(0)*adag(1)*a(0)*a(1) - 0.120200490713*adag(1)*adag(0)*a(1)*a(0) + 0.7080240981;
...
/*
    auto H =  createObservable("(-0.165606823582,-0)  1^ 2^ 1 2 + (0.120200490713,0)  1^ 0^ 0 1 + "
